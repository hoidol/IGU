...
/**
 * Created by Hoyoung on 2017-08-14.
 */

public class CheckAcceptDialog extends Dialog {

    public CheckAcceptDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_accept_layout);
